---
name: Custom Logic Samples
about: http://tiny.cc/s4-cust-logic
title: ''
labels: s4-cust-logic
assignees: ''

---

This is an issue for the [Custom Logic Samples](http://tiny.cc/s4-cust-logic) SAP S/4HANA Cloud Extensibility Scenario. Please fill the issue details using a template below.
